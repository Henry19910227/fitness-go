...
type controller struct {
	resolver course_release_monthly_statistic.Resolver
}

func New(resolver course_release_monthly_statistic.Resolver) Controller {
	return &controller{resolver: resolver}
}

// GetCMSCourseReleaseMonthlyStatistic 獲取課表上架統計月報表
// @Summary 獲取課表上架統計月報表
// @Description 獲取課表上架統計月報表
// @Tags CMS數據管理_v2
// @Accept json
// @Produce json
