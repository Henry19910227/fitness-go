...
// CreateTrainerWorkoutSets 創建教練訓練組
// @Summary 創建教練訓練組
// @Description 創建教練訓練組
// @Tags 教練課表_v2
// @Accept json
...
// @Security fitness_token
// @Param workout_id path int64 true "訓練id"
// @Param json_body body workout_set.APICreateTrainerWorkoutSetsBody true "輸入參數"
// @Success 200 {object} workout_set.APICreateTrainerWorkoutSetsOutput "0:Success/ 9000:Bad Request/ 9005:Invalid Token/ 9006:Permission denied"
// @Failure 400 {object} base.Output "失敗!"
// @Router /v2/trainer/workout/{workout_id}/workout_sets [POST]
func (c *controller) CreateTrainerWorkoutSets(ctx *gin.Context) {
	var input model.APICreateTrainerWorkoutSetsInput
	input.UserID = ctx.MustGet("uid").(int64)
	if err := ctx.ShouldBindJSON(&input.Body); err != nil {
		ctx.JSON(http.StatusBadRequest, baseModel.BadRequest(util.PointerString(err.Error())))
		return
	...
	output := c.resolver.APICreateTrainerWorkoutSets(ctx.MustGet("tx").(*gorm.DB), &input)
	ctx.JSON(http.StatusOK, output)
}
...
// UpdateTrainerWorkoutSet 更新教練訓練組
// @Summary 更新教練訓練組
// @Description 前導音檔 : {Base URL}/v2/resource/workout_set/start_audio/{Filename}.mp3 進行中音檔 : {Base URL}/v2/resource/workout_set/progress_audio/{Filename}.mp3
// @Tags 教練課表_v2
// @Accept json
...
// @Param start_audio formData file false "訓練前導音檔"
// @Param progress_audio formData file false "訓練中音檔"
// @Success 200 {object} workout_set.APIUpdateTrainerWorkoutSetOutput "0:Success/ 9000:Bad Request/ 9005:Invalid Token/ 9006:Permission denied"
// @Failure 400 {object} base.Output "失敗!"
// @Router /v2/trainer/workout_set/{workout_set_id} [PATCH]
func (c *controller) UpdateTrainerWorkoutSet(ctx *gin.Context) {
	input := model.APIUpdateTrainerWorkoutSetInput{}
	input.UserID = ctx.MustGet("uid").(int64)
	if err := ctx.ShouldBindUri(&input.Uri); err != nil {
		ctx.JSON(http.StatusBadRequest, baseModel.BadRequest(util.PointerString(err.Error())))
		return
	...
	output := c.resolver.APIUpdateTrainerWorkoutSet(ctx.MustGet("tx").(*gorm.DB), &input)
	ctx.JSON(http.StatusOK, output)
}

// DeleteTrainerWorkoutSetStartAudio 刪除教練訓練組前導語音
// @Summary 刪除教練訓練組前導語音
// @Description 刪除教練訓練組前導語音
// @Tags 教練課表_v2
// @Accept json
// @Produce json
// @Security fitness_token
// @Param workout_set_id path int64 true "訓練組id"
// @Success 200 {object} workout_set.APIDeleteTrainerWorkoutSetStartAudioOutput "0:Success/ 9000:Bad Request/ 9005:Invalid Token/ 9006:Permission denied"
// @Failure 400 {object} base.Output "失敗!"
// @Router /v2/trainer/workout_set/{workout_set_id}/start_audio [DELETE]
func (c *controller) DeleteTrainerWorkoutSetStartAudio(ctx *gin.Context) {
	var input model.APIDeleteTrainerWorkoutSetStartAudioInput
	input.UserID = ctx.MustGet("uid").(int64)
	if err := ctx.ShouldBindUri(&input.Uri); err != nil {
		ctx.JSON(http.StatusBadRequest, baseModel.BadRequest(util.PointerString(err.Error())))
		return
	}
	output := c.resolver.APIDeleteTrainerWorkoutSetStartAudio(&input)
	ctx.JSON(http.StatusOK, output)
}

// DeleteTrainerWorkoutSetProgressAudio 刪除教練訓練組進行中語音
...
// @Security fitness_token
// @Param workout_set_id path int64 true "訓練組id"
// @Success 200 {object} workout_set.APIDeleteTrainerWorkoutSetProgressAudioOutput "0:Success/ 9000:Bad Request/ 9005:Invalid Token/ 9006:Permission denied"
// @Failure 400 {object} base.Output "失敗!"
// @Router /v2/trainer/workout_set/{workout_set_id}/progress_audio [DELETE]
func (c *controller) DeleteTrainerWorkoutSetProgressAudio(ctx *gin.Context) {
	var input model.APIDeleteTrainerWorkoutSetProgressAudioInput
	input.UserID = ctx.MustGet("uid").(int64)
	if err := ctx.ShouldBindUri(&input.Uri); err != nil {
		ctx.JSON(http.StatusBadRequest, baseModel.BadRequest(util.PointerString(err.Error())))
		return
	}
	output := c.resolver.APIDeleteTrainerWorkoutSetProgressAudio(&input)
	ctx.JSON(http.StatusOK, output)
}

// CreateTrainerWorkoutSetByDuplicate 複製教練訓練組
// @Summary 複製教練訓練組
// @Description 複製教練訓練組
// @Tags 教練課表_v2
// @Accept json
...
// @Security fitness_token
// @Param workout_set_id path int64 true "訓練組id"
// @Param json_body body workout_set.APICreateTrainerWorkoutSetByDuplicateBody true "輸入參數"
// @Success 200 {object} workout_set.APICreateTrainerWorkoutSetByDuplicateOutput "0:Success/ 9000:Bad Request/ 9005:Invalid Token/ 9006:Permission denied"
// @Failure 400 {object} base.Output "失敗!"
// @Router /v2/trainer/workout_set/{workout_set_id}/duplicate [POST]
func (c *controller) CreateTrainerWorkoutSetByDuplicate(ctx *gin.Context) {
	var input model.APICreateTrainerWorkoutSetByDuplicateInput
	input.UserID = ctx.MustGet("uid").(int64)
	if err := ctx.ShouldBindJSON(&input.Body); err != nil {
		ctx.JSON(http.StatusBadRequest, baseModel.BadRequest(util.PointerString(err.Error())))
		return
...
// GetStoreWorkoutSets 獲取商店課表訓練組列表
// @Summary 獲取商店課表訓練組列表
...
// @Security fitness_token
// @Param workout_id path int64 true "訓練id"
// @Success 200 {object} workout_set.APIGetStoreWorkoutSetsOutput "成功!"
// @Failure 400 {object} base.Output "失敗!"
// @Router /v2/store/workout/{workout_id}/workout_sets [GET]
func (c *controller) GetStoreWorkoutSets(ctx *gin.Context) {
	var input model.APIGetStoreWorkoutSetsInput
	input.UserID = ctx.MustGet("uid").(int64)
	if err := ctx.ShouldBindUri(&input.Uri); err != nil {
		ctx.JSON(http.StatusBadRequest, baseModel.BadRequest(util.PointerString(err.Error())))
		return
	}
	output := c.resolver.APIGetStoreWorkoutSets(&input)
	ctx.JSON(http.StatusOK, output)
}
