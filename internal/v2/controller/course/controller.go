...
// GetTrainerCourseOverview 獲取教練課表預覽
// @Summary 獲取教練課表預覽
// @Description 獲取教練課表預覽
// @Tags 教練課表_v2
// @Accept json
// @Produce json
// @Security fitness_token
// @Param course_id path int64 true "課表id"
// @Success 200 {object} api_get_trainer_course_overview.Output "Success!"
// @Failure 400 {object} base.Output "失敗!"
// @Router /v2/trainer/course/{course_id}/overview [GET]
func (c *controller) GetTrainerCourseOverview(ctx *gin.Context) {
	var input api_get_trainer_course_overview.Input
	input.UserID = ctx.MustGet("uid").(int64)
	if err := ctx.ShouldBindUri(&input.Uri); err != nil {
		ctx.JSON(http.StatusBadRequest, baseModel.BadRequest(util.PointerString(err.Error())))
		return
...
// GetTrainerCourseStatistics 獲取教練課表數據列表
// @Summary 獲取教練課表數據列表
// @Description 獲取教練課表數據列表
// @Tags 教練課表數據_v2
// @Accept json
// @Produce json
// @Security fitness_token
// @Param page query int true "頁數(從第一頁開始)"
// @Param size query int true "筆數"
// @Success 200 {object} api_get_trainer_course_statistics.Output "Success!"
// @Failure 400 {object} base.Output "失敗!"
// @Router /v2/trainer/course/statistics [GET]
func (c *controller) GetTrainerCourseStatistics(ctx *gin.Context) {
	var input api_get_trainer_course_statistics.Input
	input.UserID = ctx.MustGet("uid").(int64)
	if err := ctx.ShouldBindQuery(&input.Query); err != nil {
		ctx.JSON(http.StatusBadRequest, baseModel.BadRequest(util.PointerString(err.Error())))
		return
	}
	output := c.resolver.APIGetTrainerCourseStatistics(&input)
	ctx.JSON(http.StatusOK, output)
}
...
// @Security fitness_token
// @Param course_id path int64 true "課表id"
// @Success 200 {object} api_get_trainer_course.Data "0:Success/ 9000:Bad Request/ 9005:Invalid Token/ 9006:Permission denied"
// @Failure 400 {object} base.Output "失敗!"
// @Router /v2/trainer/course/{course_id} [GET]
func (c *controller) GetTrainerCourse(ctx *gin.Context) {
	var input api_get_trainer_course.Input
	input.UserID = ctx.MustGet("uid").(int64)
	if err := ctx.ShouldBindUri(&input.Uri); err != nil {
		ctx.JSON(http.StatusBadRequest, baseModel.BadRequest(util.PointerString(err.Error())))
		return
...
// @Security fitness_token
// @Param course_id path int64 true "課表id"
// @Success 200 {object} api_get_store_course.Output "0:Success/ 9000:Bad Request/ 9005:Invalid Token/ 9006:Permission denied"
// @Failure 400 {object} base.Output "失敗!"
// @Router /v2/store/course/{course_id} [GET]
func (c *controller) GetStoreCourse(ctx *gin.Context) {
	var input api_get_store_course.Input
	input.UserID = ctx.MustGet("uid").(int64)
	if err := ctx.ShouldBindUri(&input.Uri); err != nil {
		ctx.JSON(http.StatusBadRequest, baseModel.BadRequest(util.PointerString(err.Error())))
		return
