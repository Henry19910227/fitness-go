...
func SetRoute(v2 *gin.RouterGroup) {
	...
	v2.POST("/food", midd.Verify([]global.Role{global.UserRole}), controller.CreateFood)
	v2.DELETE("/food/:food_id", midd.Verify([]global.Role{global.UserRole}), controller.DeleteFood)
