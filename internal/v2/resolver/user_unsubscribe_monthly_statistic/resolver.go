...
import (
	...
	"github.com/Henry19910227/fitness-go/internal/v2/service/user_unsubscribe_monthly_statistic"
	"strconv"
	"time"
)

type resolver struct {
	statisticService user_unsubscribe_monthly_statistic.Service
}

func New(statisticService user_unsubscribe_monthly_statistic.Service) Resolver {
