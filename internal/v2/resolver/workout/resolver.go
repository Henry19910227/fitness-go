...
func (r *resolver) APIDeleteTrainerWorkoutStartAudio(input *model.APIDeleteTrainerWorkoutStartAudioInput) (output model.APIDeleteTrainerWorkoutStartAudioOutput) {
	// 查詢關聯課表
	findCourseInput := courseModel.FindInput{}
	findCourseInput.WorkoutID = util.PointerInt64(input.Uri.ID)
	courseOutput, err := r.courseService.Find(&findCourseInput)
...
func (r *resolver) APIDeleteTrainerWorkoutEndAudio(input *model.APIDeleteTrainerWorkoutEndAudioInput) (output model.APIDeleteTrainerWorkoutEndAudioOutput) {
	// 查詢關聯課表
	findCourseInput := courseModel.FindInput{}
	findCourseInput.WorkoutID = util.PointerInt64(input.Uri.ID)
	courseOutput, err := r.courseService.Find(&findCourseInput)
