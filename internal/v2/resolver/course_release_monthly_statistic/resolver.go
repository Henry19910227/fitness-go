...
type resolver struct {
	statisticService course_release_monthly_statistic.Service
}

func New(statisticService course_release_monthly_statistic.Service) Resolver {
	return &resolver{statisticService: statisticService}
}

func (r *resolver) APIGetCMSCourseReleaseStatistic(input *api_get_cms_statistic_monthly_course_release.Input) (output api_get_cms_statistic_monthly_course_release.Output) {
	...
	data := api_get_cms_statistic_monthly_course_release.Data{}
	// 存在統計資料就 parser
