...
func (r *resolver) APIGetCMSCourseTrainingStatistic(input *model.APIGetCMSCourseTrainingStatisticInput) (output model.APIGetCMSCourseTrainingStatisticOutput) {
	data := model.APIGetCMSCourseTrainingStatisticData{}
