...
func (r *resolver) APIGetCMSCourseCreateStatistic(input *model.APIGetCMSCourseCreateStatisticInput) (output model.APIGetCMSCourseCreateStatisticOutput) {
	data := model.APIGetCMSCourseCreateStatisticData{}
