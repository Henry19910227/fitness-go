...
type resolver struct {
	statisticService course_create_monthly_statistic.Service
}

func New(statisticService course_create_monthly_statistic.Service) Resolver {
	return &resolver{statisticService: statisticService}
}

func (r *resolver) APIGetCMSStatisticMonthlyCourseCreate(input *api_get_cms_statistic_monthly_course_create.Input) (output api_get_cms_statistic_monthly_course_create.Output) {
	...
	data := api_get_cms_statistic_monthly_course_create.Data{}
	// 存在統計資料就 parser
