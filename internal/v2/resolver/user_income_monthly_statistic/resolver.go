...
type resolver struct {
	statisticService user_income_monthly_statistic.Service
}

func New(statisticService user_income_monthly_statistic.Service) Resolver {
	return &resolver{statisticService: statisticService}
}

func (r *resolver) APIGetTrainerIncomeMonthlyStatistic(input *api_get_trainer_income_monthly_statistic.Input) (output api_get_trainer_income_monthly_statistic.Output) {
	// 獲取當前年份
	...
	// Parse Output
	data := api_get_trainer_income_monthly_statistic.Data{}
