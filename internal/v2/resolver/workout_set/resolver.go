...
func (r *resolver) APICreateTrainerRestSet(input *model.APICreateTrainerRestSetInput) (output model.APICreateTrainerRestSetOutput) {
	// 查詢關聯課表
	findCourseInput := courseModel.FindInput{}
	findCourseInput.WorkoutID = util.PointerInt64(input.Uri.WorkoutID)
	courseOutput, err := r.courseService.Find(&findCourseInput)
...
func (r *resolver) APIDeleteTrainerWorkoutSetStartAudio(input *model.APIDeleteTrainerWorkoutSetStartAudioInput) (output model.APIDeleteTrainerWorkoutSetStartAudioOutput) {
	// 查詢關聯課表
	findCourseInput := courseModel.FindInput{}
	findCourseInput.WorkoutSetID = util.PointerInt64(input.Uri.ID)
	courseOutput, err := r.courseService.Find(&findCourseInput)
...
func (r *resolver) APIDeleteTrainerWorkoutSetProgressAudio(input *model.APIDeleteTrainerWorkoutSetProgressAudioInput) (output model.APIDeleteTrainerWorkoutSetProgressAudioOutput) {
	// 查詢關聯課表
	findCourseInput := courseModel.FindInput{}
	findCourseInput.WorkoutSetID = util.PointerInt64(input.Uri.ID)
	courseOutput, err := r.courseService.Find(&findCourseInput)
