...
import (
	...
	"github.com/Henry19910227/fitness-go/internal/v2/repository/course_category_training_monthly_statistic"
	"gorm.io/gorm"
)

type service struct {
	repository course_category_training_monthly_statistic.Repository
}

func New(repository course_category_training_monthly_statistic.Repository) Service {
