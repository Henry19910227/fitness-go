...
import (
	...
	"github.com/Henry19910227/fitness-go/internal/v2/repository/user_unsubscribe_monthly_statistic"
	"gorm.io/gorm"
)

type service struct {
	repository user_unsubscribe_monthly_statistic.Repository
}

func New(repository user_unsubscribe_monthly_statistic.Repository) Service {
