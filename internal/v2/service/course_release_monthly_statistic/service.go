...
import (
	...
	"github.com/Henry19910227/fitness-go/internal/v2/repository/course_release_monthly_statistic"
	"gorm.io/gorm"
)

type service struct {
	repository course_release_monthly_statistic.Repository
}

func New(repository course_release_monthly_statistic.Repository) Service {
