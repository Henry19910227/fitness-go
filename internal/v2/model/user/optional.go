...
type HeightOptional struct {
	Height *float64 `json:"height,omitempty" binding:"omitempty,min=1,max=250" example:"176.5"` // 身高
}
type WeightOptional struct {
	Weight *float64 `json:"weight,omitempty" binding:"omitempty,min=1,max=250" example:"70.5"` // 體重
}
