...
type CourseIDField struct {
	CourseID *int64 `json:"course_id,omitempty" uri:"course_id" gorm:"column:course_id" example:"1"` //課表id
}

type NameField struct {
	Name *string `json:"name,omitempty" gorm:"column:name" example:"第一週增肌計畫"` //計畫名稱
}

type WorkoutCountField struct {
	WorkoutCount *int `json:"workout_count,omitempty" gorm:"column:workout_count" example:"10"` //訓練數量
}
