...
type SourceField struct {
	Source *int `json:"source,omitempty" gorm:"column:source" example:"1"` //來源(1:系統創建食物/2:用戶創建食物)
}
type NameField struct {
	Name *string `json:"name,omitempty" gorm:"column:name" example:"蕃薯"` //食物名稱
}
type CalorieField struct {
	Calorie *int `json:"calorie,omitempty" gorm:"column:calorie" example:"300"` //食物熱量
}
type AmountDescField struct {
	AmountDesc *string `json:"amount_desc,omitempty" gorm:"column:amount_desc" example:"一份三百卡"` //份量描述
}
