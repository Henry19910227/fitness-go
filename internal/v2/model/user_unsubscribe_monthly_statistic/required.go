...
type FemaleRequired struct {
	Female int `json:"female" example:"400"` //女性退訂人數
}
type Age13to17Required struct {
	Age13to17 int `json:"age_13_17" example:"100"` //13-17歲退訂人數
}
type Age18to24Required struct {
	Age18to24 int `json:"age_18_24" example:"150"` //18-24歲退訂人數
}
type Age25to34Required struct {
	Age25to34 int `json:"age_25_34" example:"250"` //25-34歲退訂人數
}
type Age35to44Required struct {
	Age35to44 int `json:"age_35_44" example:"200"` //35_44歲退訂人數
}
type Age45to54Required struct {
	Age45to54 int `json:"age_45_54" example:"150"` //45_54歲退訂人數
}
type Age55to64Required struct {
	Age55to64 int `json:"age_55_64" example:"100"` //55_64歲退訂人數
}
type Age65UpRequired struct {
	Age65Up int `json:"age_65_up" example:"50"` //65+歲退訂人數
}
