release:
	docker build -t toyokoyo199/fitness-backend:2.0.25 --build-arg mode=release .
	docker push toyokoyo199/fitness-backend:2.0.25
production:
	docker build -t toyokoyo199/fitness-production-backend:2.0.25 --build-arg mode=production .
	docker push toyokoyo199/fitness-production-backend:2.0.25
