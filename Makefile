release:
	docker build -t toyokoyo199/fitness-backend:1.9.0 --build-arg mode=release .
	docker push toyokoyo199/fitness-backend:1.9.0
...
migrate_force:
	migrate -database mysql://henry:aaaa8027@tcp\(localhost:8889\)/fitness -path migrations/ force 20211216170217