release:
	docker build -t toyokoyo199/fitness-backend:2.0.22 --build-arg mode=release .
	docker push toyokoyo199/fitness-backend:2.0.22
...
migrate_create:
	migrate create -ext sql -dir migrations create_android_versions_table_v_2_0_22
