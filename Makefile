release:
	docker build -t toyokoyo199/fitness-backend:2.0.2 --build-arg mode=release .
	docker push toyokoyo199/fitness-backend:2.0.2
...
migrate_create:
	migrate create -ext sql -dir migrations add_actions_table_is_deleted_column_v_2_0_2
