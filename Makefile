release:
	docker build -t toyokoyo199/fitness-backend:2.0.13 --build-arg mode=release .
	docker push toyokoyo199/fitness-backend:2.0.13
...
migrate_create:
	migrate create -ext sql -dir migrations create_course_category_training_monthly_statistics_table_v_2_0_13
