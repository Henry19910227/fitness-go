release:
	docker build -t toyokoyo199/fitness-backend:2.0.14 --build-arg mode=release .
	docker push toyokoyo199/fitness-backend:2.0.14
...
migrate_create:
	migrate create -ext sql -dir migrations create_course_training_avg_statistics_table_v_2_0_13
