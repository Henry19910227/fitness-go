CREATE TABLE IF NOT EXISTS courses (
   `id` INT(11) PRIMARY KEY AUTO_INCREMENT COMMENT '課表 id',
   ...
   `equipment` VARCHAR(10) NOT NULL DEFAULT '' COMMENT '所需器材(0:無需任何器材/1:啞鈴/2:槓鈴/3:固定式器材/4:彈力繩/5:壺鈴/6:訓練椅/7:瑜珈墊/8:其他)',
