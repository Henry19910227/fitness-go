CREATE TABLE IF NOT EXISTS workout_logs (
    ...
    `intensity`      TINYINT(1) UNSIGNED NOT NULL DEFAULT '1' COMMENT '訓練強度(1:輕鬆/2:適中/3:稍難/4:很累)',
    `place`          TINYINT(1) UNSIGNED NOT NULL DEFAULT '1' COMMENT '地點(1:住家/2:健身房/3:戶外)',
